      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <p className="mt-3 max-w-sm text-sm text-light-dark">
              {brand.tagline}
            </p>
          </div>
            ...
            <ul className="mt-3 space-y-2">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm text-light-dark transition-colors hover:text-primary"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <div className="mt-3 flex gap-4">
              <a
                ...
                className="text-light-dark transition-colors hover:text-primary"
                aria-label="GitHub"
              >
        ...
        <div className="mt-8 border-t border-border pt-8 text-center text-sm text-light-dark">
